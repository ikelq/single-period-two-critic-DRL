...
class SACAgent:
    ...
    def train(self, num_frames: int, plotting_interval: int = 400):
        ...
        data_train.to_csv('trainsac' + str(self.env.name) + str(self.seed) + 'tootsa'+'local'+str(self.is_local)+'.csv')
        ...
        data_train_test.to_csv('traintestsac' + str(self.env.name) + str(self.seed) + 'tootsa'+'local'+str(self.is_local)+'.csv')
        ...
        data_train_loss.to_csv('trainlosssac' + str(self.env.name) + str(self.seed) + 'tootsa'+'local'+str(self.is_local)+'.csv')
        #
